export default {
  ...
  aiAgents: {
    ...
    scene: { chat: 'Chat', agentGenerate: 'Agent Generation', imageGenerate: 'Image Generation', canvasTextGenerate: 'Infinite Canvas Chat', canvasImageGenerate: 'Infinite Canvas Image', canvasVideoGenerate: 'Infinite Canvas Video' },
  ...
  aiImages: {
    ...
    subtitle: 'Submit async gpt-image-2 tasks through image_generate agents. History and assets are persisted on the server.',
    agent: 'Agent',
    ...
    referenceHint: 'Up to 10 images. Uploads are registered as server assets first.',
    uploadReference: 'Upload Reference',
    uploadDone: 'Image asset registered',
