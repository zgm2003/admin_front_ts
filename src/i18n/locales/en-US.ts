export default {
  ...
  menu: {
    ...
    ai_runs: 'Run Monitor',
    ai_tools: 'AI Tools',
    ai_image_playground: 'Image Playground',
    // DevTools module
  ...
  aiImages: {
    ...
    studioSubtitle: 'Shares the same image task capability as Canvas; only the platform surface differs.',
    agent: 'Agent',
    model: 'Model',
    agentPlaceholder: 'Select an image generation agent',
    prompt: 'Prompt',
    promptPlaceholder: 'Describe the image to generate or edit',
    promptLibrary: 'Prompt Library',
    promptSearchPlaceholder: 'Search prompt title, category, or content',
    emptyPromptLibrary: 'No prompts available',
    promptLoadFailed: 'Failed to load prompt library',
    promptApplied: 'Prompt applied',
    assetLibrary: 'Asset Library',
    assetSearchPlaceholder: 'Search image assets',
    emptyAssetLibrary: 'No image assets',
    assetLoadFailed: 'Failed to load asset library',
    assetUrlMissing: 'Asset has no image URL and cannot be used as a reference',
    clipboardReference: 'Clipboard Reference',
    size: 'Size',
    quality: 'Quality',
    n: 'Images',
    ...
    referenceHint: 'Up to 10 images. Uploads are persisted with the task.',
    referenceCount: '{count} reference images',
    referenceLimitReached: 'Reference images are limited to {max}',
    uploadReference: 'Upload Reference',
    uploadDone: 'Image file added to task',
    uploadFailed: 'Image upload failed',
    addReferenceDone: 'Added to references',
    addReferenceFailed: 'Failed to add reference',
    assetTypeRequired: 'Select an image asset',
    assetUrlRequired: 'Image asset must have a valid URL',
    clipboardReferenceRequired: 'Clipboard must contain a valid image URL',
    assetMimeRequired: 'Image URL must include a recognizable image extension',
    imageDimensionsFailed: 'Failed to read image dimensions',
    imageMimeRequired: 'Only image files with a valid MIME type can be uploaded',
    emptyAssets: 'No reference images',
    mask: 'Mask',
    maskEdit: 'Mask Edit',
    maskTarget: 'Mask Target',
    maskTargetPlaceholder: 'Select the reference image affected by the mask',
    maskTargetRequired: 'Select the reference image affected by the mask',
    maskTip: 'The first version accepts an uploaded mask and binds it to a target reference image explicitly.',
    ...
    submitFailed: 'Failed to submit image task',
    history: 'History',
    historyTip: 'Server history is the source of truth and can be refreshed or reused.',
    ...
    statusFailed: 'Failed',
    emptyHistory: 'No image tasks',
    detail: 'Task Detail',
    emptyDetail: 'No task detail',
    detailFailed: 'Failed to load image task detail',
    provider: 'Provider',
    elapsed: 'Elapsed',
    createdAt: 'Created At',
    ...
    error: 'Error',
    outputs: 'Outputs',
    resultSubtitle: 'Select a task on the left or submit a new one to inspect outputs.',
    resultPending: 'Generating image...',
    resultPendingTip: 'The task has been submitted. Outputs will appear here when ready.',
    resultFailed: 'Generation failed',
    emptyResultPanel: 'No generated image yet',
    emptyOutputs: 'No outputs',
    addToAssets: 'Add to Assets',
    addToReferences: 'Add to References',
    generatedAssetTitle: 'AI image #{id}',
    saveAssetDone: 'Added to asset library',
    saveAssetFailed: 'Failed to add asset',
    download: 'Download',
    retry: 'Retry',
    reuse: 'Reuse',
    reuseDone: 'Reused in composer',
    confirmDelete: 'Delete this image task?',
    deleteFailed: 'Failed to delete image task',
    deletePartialFailed: '{count} image tasks failed to delete. The list has been refreshed.',
    refreshFailed: 'Failed to refresh image task list',
    initFailed: 'Failed to initialize image playground'
  },
  aiChat: {
