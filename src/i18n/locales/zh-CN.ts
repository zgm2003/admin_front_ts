export default {
  ...
  pay_order: {
    filter: { order_no: '订单号', user_id: '用户ID' },
    table: {
      order_no: '订单号', user_id: '用户ID', order_type: '订单类型', title: '商品标题',
      pay_amount: '支付金额', refunded_amount: '已退金额', channel: '支付渠道', pay_method: '支付方式',
      pay_status: '支付状态', biz_status: '业务状态', refund_status: '退款状态',
  ...
  pay_transaction: {
    filter: { order_no: '订单号', transaction_no: '流水号' },
    table: {
      transaction_no: '流水号', order_no: '订单号', attempt_no: '支付次数',
  ...
  pay_refund: {
    filter: { refund_no: '退款号', order_no: '订单号' },
    table: {
      refund_no: '退款号', order_no: '订单号', channel: '支付渠道',
      refund_amount: '退款金额', wallet_freeze_amount: '冻结金额', trade_refund_no: '第三方退款号',
      status: '状态', reason: '退款原因', fail_reason: '失败原因',
      frozen_at: '冻结时间', refunded_at: '退款时间', created_at: '创建时间',
    },
    actions: { apply: '申请退款' },
    form: { order_id: '订单ID', transaction_id: '交易ID', refund_amount: '退款金额（元）', reason: '退款原因' },
    detail: { title: '退款详情', order: '关联订单', raw_request: '原始请求', raw_notify: '原始回调' },
  },
  pay_wallet: {
    filter: { user_id: '用户ID' },
    table: {
      user_id: '用户ID', balance: '余额', frozen: '冻结金额', available: '可用余额',
      total_recharge: '累计充值', total_consume: '累计消费', total_refund: '累计退款',
      created_at: '创建时间',
    },
    actions: { transactions: '钱包流水', adjust: '调账' },
    form: { user_id: '用户ID', delta: '调整金额（元）', reason: '调账原因' },
    txn: {
      title: '钱包流水', table: {
  ...
  personal: {
    ...
    recharge: {
      ...
      copySuccess: '支付内容已复制',
      ordersTitle: '我的充值订单',
      ordersDesc: '这里会记录当前账号创建过的充值订单，包括未支付、已支付、已关闭和退款状态。',
      ordersEmpty: '暂无充值订单',
      ...
      viewOrder: '查看订单',
      historyTitle: '最近钱包流水',
      historyDesc: '充值、消费、退款等资金流水会记录在这里，便于快速核对资金变动。',
      historyEmpty: '暂无钱包流水',
      type: '类型',
      change: '资金变动',
      balanceAfter: '变动后余额',
