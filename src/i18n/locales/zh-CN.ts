export default {
  ...
  aiImages: {
    ...
    studioTitle: '生图工作台',
    studioSubtitle: '和 Canvas 使用同一套图片任务能力，区别只在平台入口。',
    agent: '选择智能体',
    model: '模型',
    agentPlaceholder: '请选择图片生成智能体',
    prompt: '提示词',
    promptPlaceholder: '描述要生成或编辑的图片内容',
    promptLibrary: '查看提示词库',
    promptSearchPlaceholder: '搜索提示词标题、分类或内容',
    emptyPromptLibrary: '暂无可用提示词',
    promptLoadFailed: '提示词库加载失败',
    promptApplied: '提示词已应用',
    assetLibrary: '素材库',
    assetSearchPlaceholder: '搜索图片素材',
    emptyAssetLibrary: '暂无图片素材',
    assetLoadFailed: '素材库加载失败',
    assetUrlMissing: '素材缺少图片 URL，不能作为参考图',
    clipboardReference: '粘贴板参考图',
    size: '尺寸',
    quality: '质量',
    n: '张数',
    ...
    qualityHigh: '高',
    referenceImages: '参考图',
    referenceHint: '最多 10 张，上传后随本次任务一起入库。',
    referenceCount: '当前 {count} 张参考图',
    referenceLimitReached: '参考图最多 {max} 张',
    uploadReference: '上传参考图',
    uploadDone: '图片文件已加入任务',
    uploadFailed: '图片上传失败',
    addReferenceDone: '已加入参考图',
    addReferenceFailed: '加入参考图失败',
    assetTypeRequired: '请选择图片类型素材',
    assetUrlRequired: '图片素材必须有有效 URL',
    clipboardReferenceRequired: '剪贴板必须包含有效图片 URL',
    assetMimeRequired: '图片 URL 必须带有可识别的图片扩展名',
    imageDimensionsFailed: '无法读取图片尺寸',
    imageMimeRequired: '只能上传带有有效 MIME 类型的图片文件',
    emptyAssets: '暂无参考图',
    mask: '遮罩',
    maskEdit: '遮罩编辑',
    maskTarget: '遮罩目标图',
    maskTargetPlaceholder: '请选择遮罩作用的参考图',
    maskTargetRequired: '请选择遮罩作用的参考图',
    maskTip: '首版通过上传遮罩图完成编辑，并显式绑定目标参考图，避免遮罩错位。',
    uploadMask: '上传遮罩图',
    clearMask: '清除遮罩',
    generate: '生成图片',
    ...
    history: '历史任务',
    historyTip: '服务端历史是唯一事实源，刷新后仍可查看和复用。',
    records: '生成记录',
    ...
    error: '错误信息',
    outputs: '生成结果',
    resultSubtitle: '选择左侧任务或提交新任务后查看结果。',
    resultPending: '生成中',
    resultPendingTip: '任务已提交，完成后结果会显示在这里。',
    resultFailed: '生成失败',
    emptyResultPanel: '还没有生成图片',
    emptyOutputs: '暂无生成结果',
    addToAssets: '添加到素材',
    addToReferences: '加入参考图',
    generatedAssetTitle: 'AI 图片 #{id}',
    saveAssetDone: '已添加到素材库',
    saveAssetFailed: '添加到素材库失败',
    download: '下载',
    retry: '重试',
    reuse: '复用',
    reuseDone: '已复用到编辑区',
    confirmDelete: '确定删除该图片任务吗？',
    deleteFailed: '删除图片任务失败',
    deletePartialFailed: '{count} 个图片任务删除失败，列表已刷新',
    refreshFailed: '刷新图片任务列表失败',
    initFailed: '图片工作台初始化失败'
  },
  aiChat: {
