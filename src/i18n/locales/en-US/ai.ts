...
export default {
  aiProviders: {
      ...
      form: {
        ...
        baseUrl: 'Base URL',
        status: 'Status',
        fileInputMode: 'File transport protocol',
        fileInputModeHint: 'Declare only the request protocol supported by this route. Model capability still comes from the official catalog.',
        apiKey: 'API Key',
  ...
  aiChat: {
      ...
      providerFileInputDisabled: 'The current provider route has not enabled file transfer',
  ...
  aiRuns: {
      ...
      detail: {
		...
		fileInputMode: 'Provider File Protocol',
