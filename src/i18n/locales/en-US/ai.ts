...
export default {
  aiProviders: {
      ...
      form: {
        ...
        modelId: 'Model ID',
        modelIdPlaceholder: 'Enter the exact model ID',
        ...
        apiProtocolHint: 'Responses API is the recommended OpenAI interface for text, images, and native files. Chat Completions remains available for text and image compatibility.',
        apiKey: 'API Key',
      ...
      modelKinds: { chat: 'Chat', embedding: 'Embedding', rerank: 'Rerank' },
      validation: { modelsRequired: 'Configure at least one model', modelIdRequired: 'Model ID is required', modelIdDuplicate: 'Model IDs must be unique' },
      actions: { test: 'Test', fetchModels: 'Fetch Models', syncModels: 'Sync Models', addModel: 'Add Model', removeModel: 'Remove Model' },
  ...
  aiChat: {
      ...
      waitUpload: 'Please wait for attachment upload to complete',
      uploadHasError: 'An attachment failed to upload. Retry or remove it.',
      ...
      attachmentTypeUnsupported: 'The current agent does not support this attachment type',
      attachmentTooLarge: 'The attachment exceeds the current per-file limit',
      attachmentTotalTooLarge: 'The message attachment total exceeds the limit',
      attachmentDuplicate: 'Duplicate attachment ignored',
      providerApiProtocolUnsupported: 'The provider is not using Responses API, so files cannot be sent',
      modelFileInputUnsupported: 'The current model does not support file input',
      transportFileInputUnsupported: 'The current transport does not support file input',
      uploadRuleUnavailable: 'The active upload rule is unavailable. Contact an administrator.',
      attachmentContextTooLarge: 'Conversation file context exceeds 50 MB. Start a new chat or reduce history.',
      attachmentObjectUnavailable: 'The attachment is no longer available. Upload it again.',
      attachmentObjectVersionChanged: 'The attachment changed. Upload it again.',
      providerFilePartRejected: 'The upstream provider rejected file input',
      // Input hints
      inputHint: 'Enter to send, Shift + Enter for new line',
      inputHintImage: ', supports paste/drag images',
      inputHintAttachment: ', supports selecting, pasting, or dragging attachments',
  ...
  aiRuns: {
      ...
      detail: {
        ...
        rawSnapshot: 'Raw sanitized snapshot',
		...
		nativeFileCount: 'Native Files',
		nativeFileBytes: 'Native File Bytes',
		cosHeadLatency: 'COS Validation',
		cosStreamLatency: 'COS Read',
		materializedRequestBytes: 'Materialized Request Size',
		apiProtocol: 'Request Protocol',
