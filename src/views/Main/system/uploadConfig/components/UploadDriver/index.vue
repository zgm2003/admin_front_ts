...
<template>
  ...
  <el-dialog v-model="addBoxShow" :width="isMobile ? '94vw' : '900px'" :top="isMobile ? '4vh' : '20vh'">
    ...
    <el-form :model="addForm" label-width="auto">
      <el-row :gutter="12">
        <el-col :span="24">
          <el-form-item :label="t('upload.driver.form.driver')" required>
            <el-select-v2 v-model="addForm.driver" :options="dict.upload_driver_arr" style="width:100%" filterable
                          clearable/>
          </el-form-item>
        </el-col>
        <template v-if="addForm.driver==='cos'">
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.secret_id')" required>
              <el-input v-model="addForm.secret_id" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.secret_key')" required>
              <el-input v-model="addForm.secret_key" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.bucket')" required>
              <el-input v-model="addForm.bucket" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.region')" required>
              <el-input v-model="addForm.region" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.appid')">
              <el-input v-model="addForm.appid" clearable/>
            </el-form-item>
          </el-col>
        </template>
      </el-row>
  ...
  <el-dialog v-model="editBoxShow" :width="isMobile ? '94vw' : '900px'" :top="isMobile ? '4vh' : '20vh'">
    ...
    <el-form :model="editForm" label-width="auto">
      <el-row :gutter="12">
        <el-col :span="24">
          <el-form-item :label="t('upload.driver.form.driver')" required>
            <el-select-v2 v-model="editForm.driver" :options="dict.upload_driver_arr" style="width:100%" filterable
                          clearable/>
          </el-form-item>
        </el-col>
        <template v-if="editForm.driver==='cos'">
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.secret_id')" required>
              <el-input v-model="editForm.secret_id" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.secret_key')" required>
              <el-input v-model="editForm.secret_key" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.bucket')" required>
              <el-input v-model="editForm.bucket" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.region')" required>
              <el-input v-model="editForm.region" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('upload.driver.form.appid')">
              <el-input v-model="editForm.appid" clearable/>
            </el-form-item>
          </el-col>
        </template>
      </el-row>
