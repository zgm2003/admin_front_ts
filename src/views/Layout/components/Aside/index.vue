...
.aside-menu { height: 100%; border-right: none; background: var(--el-bg-color); &:not(.el-menu--collapse) { width: 220px; } }
.logo-container { display: flex; align-items: center; height: 60px; padding: 0 20px; border-bottom: 1px solid var(--el-border-color-lighter); gap: 12px; &.is-collapse { padding: 0; justify-content: center; } }
.logo-icon { width: 36px; height: 36px; border-radius: 8px; background: var(--el-color-primary); display: flex; align-items: center; justify-content: center; flex-shrink: 0; img { width: 24px; height: 24px; object-fit: contain; filter: brightness(0) invert(1); } }
